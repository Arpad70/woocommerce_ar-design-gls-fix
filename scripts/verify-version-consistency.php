...
$pluginFile = $pluginRoot . '/ar-design-gls-fix.php';
...
if (! preg_match("/define\\(\\s*'AR_DESIGN_GLS_FIX_VERSION'\\s*,\\s*'" . preg_quote($version, '/') . "'\\s*\\)/", $pluginSource)) {
    $errors[] = 'AR_DESIGN_GLS_FIX_VERSION does not match VERSION file.';
}
