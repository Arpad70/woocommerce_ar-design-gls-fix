...
final class ArDesignGlsFixRollbackManager
{
    private const BACKUP_DIR = 'ard-gls-fix-backups';
    ...
    public function rollbackOnInstallFailure($result, $hookExtra)
    {
        ...
        return new \WP_Error(
            'ard_gls_fix_rollback_performed',
            __('Aktualizácia AR Design GLS Fix zlyhala. Predchádzajúca verzia bola automaticky obnovená zo zálohy.', 'ar-design-gls-fix')
        );
    }
