...
final class ArDesignGlsFixRollbackManager extends BasePluginRollbackManager
{
    public function __construct(string $pluginBasename, string $pluginRoot)
    {
        parent::__construct(
            ...
            $pluginRoot,
            array(
                'backup_dir' => 'ard-gls-fix-backups',
                'error_code' => 'ard_gls_fix_rollback_performed',
                'error_message' => 'Aktualizácia AR Design GLS Fix zlyhala. Predchádzajúca verzia bola automaticky obnovená zo zálohy.',
